...
초등학생의 수업 참여를 돕는 협동형 교실 MMORPG입니다. 출석 확인, 자동 길드 편성, 교과별 던전, 보스 레이드, 공정한 발표자 추천, 보상 아이템과 수업 종료 리포트를 하나의 흐름으로 연결합니다.
...
- 국어·수학·과학·사회·도덕 등 교과에 따라 던전, 몬스터, 최종 보스가 달라집니다.
- 도전 공격과 정답 공격으로 보스 결계 HP를 낮추며, 모든 길드가 참여하면 협동 룬이 발동합니다.
- 누적 별에 따라 힌트 나침반, 시간의 모래, 용기의 깃발을 해금해 학급 전체가 함께 사용합니다.
